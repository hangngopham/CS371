...
public void setup()
{
   ...
   circle3 = new Circle1(1,2,3);
   circle4 = new Circle1(1,2,3);
...
@Test 
public void testConstructor1() {
  Circle1 myCircle = new Circle1(2,3);
  System.out.println("Running test testConstructor1.");
  Point c = myCircle.center;
  Assert.assertTrue(c.x==2);
  Assert.assertTrue(c.y==3);
...
//
// Test a simple move with positive x and negative y;
// 
@Test 
public void simpleMovePosXNegY() {
   Point p;
   System.out.println("Running test simpleMovePosXNegY().");
   p = circle3.moveBy(1,-1);
   Assert.assertTrue(p.x == 2 && p.y == 1);
}

//
// Test a simple move with negative x and positive y;
// 
@Test 
public void simpleMoveNegXPosY() {
   Point p;
   System.out.println("Running test simpleMoveNegXPosY().");
   p = circle4.moveBy(-1,1);
...
// than the difference of two radii). c5 is within c9 with no intersection point
//
@Test
